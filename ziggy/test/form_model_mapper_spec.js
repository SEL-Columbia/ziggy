describe("Form Model Mapper", function () {
    ...
    it("should get form model with empty field values for a given form type when there is no saved form instance, only one entity", function () {
        formDefinition = {
            "form": {
                "bind_type": "entity",
                "default_bind_path": "/Entity registration/",
        ...
        var entities = new enketo.EntityDefinitions().add(new enketo.EntityDef("entity"));
        var params = {
            "id": "id 1",
            "formName": "entity-registration",
            "entityId": "123"
